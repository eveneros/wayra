...
bgmusic = new Howl({
  src: ['sounds/PanFluteRapHypnosis.ogg'],
  loop: true,
  volume: 0.5,
  pause:true
});
...
function resetGame(){
  game = {speed:0,
          initSpeed:.000034,
          baseSpeed:.000034,
          targetBaseSpeed:.000034,
          incrementSpeedByTime:.0000009,
          incrementSpeedByLevel:.0000009,
...
function createScene() {
  ...
  camera = new THREE.PerspectiveCamera(
    ...
    scene.fog = new THREE.Fog(0xD0D5D2, 200,1800);
      //aduis
...
function sun(){
    ...
    skySun.material.uniforms.luminance.value = 0.011;//tarde:0.001
    skySun.material.uniforms.mieCoefficient.value = 1.5//0.1:esfera mas iluminada sol
    skySun.material.uniforms.mieDirectionalG.value = 0.99995;
    ...
    sunSphere.position.y = 800000 * Math.sin( phi ) * Math.sin( theta );//posicion de la esfera
...
//makeRoughGround(sea.mesh, modulate(upperMaxFr, 0, 1, 0.5, 4));
    ...
    */
    ...
    updateEnergy();
    var mouseSpeed=1;
    var calculoSpeed=(mousePos.x / WIDTH)*3500;
    if(calculoSpeed>1)
